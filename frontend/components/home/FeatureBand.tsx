...
export default function FeatureBand() {
  ...
  return (
    <section className="bg-(--dark-section) py-12 sm:py-16 px-4 sm:px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-0 relative overflow-hidden dark-band-grid">
      {features.map((feature, i) => (
        ...
        >
          ...
          <h3 className="font-sans text-base sm:text-lg font-semibold text-(--dark-text) mb-2">
            {feature.title}
          </h3>
          <p className="text-[0.82rem] leading-relaxed font-light text-(--dark-text) opacity-60">
            {feature.description}
          </p>
        </motion.div>
      ))}
